...
public class TreeTraversalTest {
    ...
    @Test
    public void testNodesTraversal_InOrder_ImplementedBy_Recursion() {
        BinaryTreeUtils.TreeValues[] expectedOrderedValues = {D, B, E, A , F, C ,G};
        ////4(D), 2(B),5(E),1(A) ,20(F),3(C),100(G)
        verifyNodesTraversalInternal(TraversalType.INORDER_RECURSION, expectedOrderedValues);
    }

    @Test
    public void testNodesTraversal_InOrder_ImplementedBy_Stack() {
        BinaryTreeUtils.TreeValues[] expectedOrderedValues = {D, B, E, A , F, C ,G};
        ////4(D), 2(B),5(E),1(A) ,20(F),3(C),100(G)
        verifyNodesTraversalInternal(TraversalType.INORDER_STACK, expectedOrderedValues);
    }

    @Test
    public void testNodesTraversal_PreOrder_ImplementedBy_Recursion() {
        BinaryTreeUtils.TreeValues[] expectedOrderedValues = {A, B, D, E , C, F ,G};
        ////1(A), 2(B), 4(D), 5(E), 3(C), 20(F), 100(G)
        verifyNodesTraversalInternal(TraversalType.PREORDER_RECURSION, expectedOrderedValues);
    }

    @Test
    public void testNodesTraversal_PreOrder_ImplementedBy_Stack() {
        BinaryTreeUtils.TreeValues[] expectedOrderedValues = {A, B, D, E , C, F ,G};
        ////1(A), 2(B), 4(D), 5(E), 3(C), 20(F), 100(G)
        verifyNodesTraversalInternal(TraversalType.PREORDER_STACK, expectedOrderedValues);
    }

    @Test
    public void testNodesTraversal_PostOrder_ImplementedBy_Recursion() {
        BinaryTreeUtils.TreeValues[] expectedOrderedValues = {D, E, B, F , G, C ,A};
        ////4(D), 5(E), 2(B), 20(F), 100(G), 3(C), 1(A))
        verifyNodesTraversalInternal(TraversalType.POSTORDER_RECURSION, expectedOrderedValues);
    }

    @Test
    public void testNodesTraversal_PostOrder_ImplementedBy_Stack() {
        BinaryTreeUtils.TreeValues[] expectedOrderedValues = {D, E, B, F , G, C ,A};
        ////4(D), 5(E), 2(B), 20(F), 100(G), 3(C), 1(A))
        verifyNodesTraversalInternal(TraversalType.POSTORDER_STACK, expectedOrderedValues);
    }

    @Test
    public void testNodesTraversal_BFS_ImplementedBy_Recursion() {
