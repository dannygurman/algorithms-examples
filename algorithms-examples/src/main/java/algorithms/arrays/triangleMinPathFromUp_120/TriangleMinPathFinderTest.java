...
public class TriangleMinPathFinderTest {
    ...
    @Test
    public void testDpBottomUpPathFinder() {

    }

    @Test
    public void tesRecursionUpPathFinder() {
        TriangleMinPathFinder recursionTriangleMinPathFinder = new RecursionTriangleMinPathFinder();
        testTrianglePathFinderInternal(recursionTriangleMinPathFinder);
    }

    private void testTrianglePathFinderInternal(TriangleMinPathFinder triangleMinPathFinder) {
